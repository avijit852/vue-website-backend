        ...
        <div class="container-fluid pt-25">
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  <h5 class="txt-dark">Query List </h5>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                  <ol class="breadcrumb">
                    <li><a href="#">Query List Management</a></li>
                  </ol>
                </div>
            </div>
                                ...
                                <div id="update_modal" class="modal fade update_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    <h5 class="modal-title">List Of Message</h5>
                                                </div>
                                                <div class="modal-body">
                                    ...
                                    <div class="table-responsive">
                                      <table id="datable_1" class="table table-hover display  table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $x++; ?></td>
                                                    <td><?= $row['askquery_name']; ?></td>
                                                    <td><?= $row['askquery_email']; ?></td>
                                                    <td><?= $row['askquery_phone']; ?></td>
                                                    <td>
                                                         <a href="#" class="mr-25 edit" data-toggle="modal" data-target="#update_modal" data-bind="<?= $row['id']; ?>" data-original-title="Edit"> <i class="zmdi zmdi-eye text-inverse m-r-10"></i></a>
                                                    </td>
                                                     <td><?= $row['askquery_iscomplete']; ?></td>    
                            ...
                            success: function(o) {
                                ...
                                for (var key in o.data ){
                                    ...
                                    // {
                                        ...
                                        output +='<tr>';
                                        output += '<td>' + c + '</td>';
                                        output += '<td>' + value.askmsg_msg + '</td>';
                                        output += '<td>' + value.askmsg_reply + '</td>';
                                        output += '<td><a href="#" class="mr-25 msg" data-toggle="modal" data-target="#replymsg_modal" data-bind="'+ value.id +'"> <i class="fa fa-pencil text-primary m-r-10"></i></a></td>';
                                        output += '</tr>';
                                    // }
