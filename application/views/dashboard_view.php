    ...
    <!-- Main Content -->
                        ...
                        <div class="panel panel-default card-view pa-0">
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box" style="background: #1aa290 !important;">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <span class="weight-500 uppercase-font txt-light block font-20" style="line-height: 56px;">Check Your</span>
                                                    
                                                </div>
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <a href="<?php echo base_url('dashboard/dailytimesheet'); ?>"><button type="button" class="btn btn-primary" style="border-radius: 15px;background: #2879ff78;display: block; margin: 8px 15px;">Exit Time</button></a>
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('.dashboard_icon1').hide();
                $('.dashboard_icon2').show();
                $('#dashboard').click();
